...
A tool often used by malicious actors or penetration testers. However, in our context, it became a controlled, benign test instrument to ensure your defensive (detection) mechanism was correctly calibrated and implemented. I made a script to ensure that it would pick up any unusual traffic from the ports.
